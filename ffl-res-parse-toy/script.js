...
const resourceFetchPath = ''; ///< Change this to something you can fetch() from.
 ...
 * @returns {{FFLiResourceHeader: Object}} An object containing FFLiResource* structures configured with the endianness provided.
 */
const createFFLiResourceStructs = (littleEndian, isAFL_2_3TextureHeader) => {
	...
	const FFLiResourcePartsInfo = _.struct([
		uint32bi('dataPos'), // Offset in resource file.
		uint32bi('dataSize'),
